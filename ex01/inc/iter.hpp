...
template <typename T>
void    iter( T* array, std::size_t const length, void ( *func )( T& ) )
{
...
template <typename T>
void    iter( T* array, std::size_t const length, void ( *func )( T const& ) )
{
    for ( std::size_t i = 0; i < length; i++ )
        func( array[ i ] );
}
...
template <typename T>
void    iter( const T* array, std::size_t const length, void ( *func )( T const& ) )
{
    for ( std::size_t i = 0; i < length; i++ )
        func( array[ i ] );
}
